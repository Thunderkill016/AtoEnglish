  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mb-1 text-4xl font-black text-emerald-400">{score}%</p>
        <p className="text-sm text-zinc-400">điểm hiểu và gọi lại có kiểm soát</p>
      </motion.div>
            ...
            {phase === "pre_watch" && (
              <>
                ...
                <PreWatchPhase
                  ...
                  onComplete={() => advance("while_watch")}
                />
              </>
            )}
            {phase === "while_watch" && (
