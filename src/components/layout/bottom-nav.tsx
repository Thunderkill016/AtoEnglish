...
export function BottomNav() {
  ...
  return (
    <nav className="sm:hidden fixed bottom-0 left-0 right-0 z-50 h-16 bg-background/80 dark:bg-zinc-950/80 backdrop-blur-lg border-t border-zinc-200/50 dark:border-zinc-800/50 flex items-center justify-around px-2 pb-safe shadow-[0_-4px_20px_rgba(0,0,0,0.03)] transition-all duration-300">
      {navItems.map((item) => {
