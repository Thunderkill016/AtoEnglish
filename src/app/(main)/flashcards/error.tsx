...
export default function FlashcardsError({
  ...
  useEffect(() => {
    Sentry.captureException(error, { tags: { location: "flashcards" } });
  }, [error]);
    ...
    <div className="relative flex min-h-[60vh] flex-col items-center justify-center px-4 text-center space-y-6">
      ...
      >
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-black text-foreground">Không thể tải Flashcards</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Đã xảy ra lỗi khi tải thẻ ôn tập. Kiểm tra kết nối mạng và thử lại.
          </p>
          {error.digest && (
