...
export const unit31: UnitData = {
  ...
  vocab: [
    ...
    { id: 5, word: "recommend", emoji: "👍", phonetic: "/ˌrekəˈmend/", meaning: "khuyến nghị / khuyên", example: "We recommend that the company invest in new technology.", example2: "She recommended hiring an assistant.", collocation: "highly recommend / recommend that / recommend doing", audio: "/audio/unit31/recommend.mp3" },
    ...
    { id: 10, word: "delay", emoji: "⏳", phonetic: "/dɪˈleɪ/", meaning: "sự chậm trễ / trì hoãn", example: "The train delay caused me to miss the meeting.", example2: "We apologize for the delay in delivery.", collocation: "cause a delay / project delay / apologize for the delay", audio: "/audio/unit31/delay.mp3" },
