...
export const unit31: UnitData = {
  ...
  vocab: [
    ...
    { id: 3, word: "inform", emoji: "📢", phonetic: "/ɪnˈfɔːm/", meaning: "thông báo / cho biết", example: "I regret to inform you that your application was unsuccessful.", example2: "Please inform us of any changes to your schedule.", collocation: "inform someone of / keep someone informed / write to inform", audio: "/audio/unit31/inform.mp3", l1_interference_vn: "⚠️ Formal: 'inform of/about'. 'I am writing to inform you that...' — chuẩn email. Không 'tell' trong business." },
    { id: 4, word: "clarify", emoji: "🔍", phonetic: "/ˈklærɪfaɪ/", meaning: "làm rõ / giải thích rõ", example: "Could you clarify the third point in the proposal?", example2: "We need to clarify our goals before starting the project.", collocation: "clarify a point / clarify the situation / need to clarify", audio: "/audio/unit31/clarify.mp3", l1_interference_vn: "⚠️ 'Clarify + N' (không 'clarify about'). Dùng khi email cần làm rõ — 'Please clarify...' lịch sự." },
    ...
    { id: 6, word: "advise", emoji: "👨‍💼", phonetic: "/ədˈvaɪz/", meaning: "khuyên / cố vấn", example: "The legal team advised us not to sign the contract yet.", example2: "I would advise caution in this business deal.", collocation: "advise someone to do / advise against / legal adviser", audio: "/audio/unit31/advise.mp3", l1_interference_vn: "⚠️ 'advise + object + to-V' hoặc 'advise against'. KHÔNG 'advise to do' không object. Lỗi VN hay 'I advise you do'." },
    { id: 7, word: "agenda", emoji: "📋", phonetic: "/əˈdʒendə/", meaning: "chương trình họp / nội dung thảo luận", example: "What is the next item on the meeting agenda?", example2: "The main agenda today is the marketing plan.", collocation: "meeting agenda / set the agenda / top of the agenda", audio: "/audio/unit31/agenda.mp3", l1_interference_vn: "⚠️ 'on the agenda' (không 'in'). 'Set the agenda' = định hướng cuộc họp. Không dịch thẳng 'chương trình'." },
    { id: 8, word: "proposal", emoji: "📂", phonetic: "/prəˈpəʊzəl/", meaning: "bản đề xuất / kế hoạch", example: "We have submitted a proposal for the project.", example2: "The board rejected the business proposal.", collocation: "project proposal / submit a proposal / review a proposal", audio: "/audio/unit31/proposal.mp3", l1_interference_vn: "⚠️ \'Proposal FOR\': \'a proposal for a new project\'. \'Make/submit a proposal\'." },
    { id: 9, word: "attachment", emoji: "📎", phonetic: "/əˈtætʃmənt/", meaning: "tệp đính kèm", example: "Please review the attachment for details.", example2: "I forgot to open the email attachment.", collocation: "email attachment / send an attachment / see attachment", audio: "/audio/unit31/attachment.mp3", l1_interference_vn: "⚠️ 'Please find the attachment' (formal). 'Attached file' cũng đúng nhưng 'attachment' chuẩn email. Không 'attach file' lặp." },
