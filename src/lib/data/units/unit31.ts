...
export const unit31: UnitData = {
  ...
  warmupGreetings: [
    ...
    { emoji: "⏳", en: "We apologize for the delay in completing the report.", vn: "Chúng tôi xin lỗi vì sự chậm trễ trong việc hoàn thành báo cáo.", context: "apologize for the delay — xin lỗi vì chậm trễ" },
  ],
  vocab: [
    { id: 1, word: "confirm", emoji: "✅", phonetic: "/kənˈfɜːm/", meaning: "xác nhận", example: "I am writing to confirm our appointment for tomorrow.", example2: "The manager confirmed that the budget was approved.", collocation: "confirm a booking / confirm an appointment / confirm details", audio: "/audio/unit31/confirm.mp3" },
    { id: 2, word: "request", emoji: "📝", phonetic: "/rɪˈkwest/", meaning: "yêu cầu (trang trọng)", example: "You can request additional funding if needed.", example2: "We received a request for more information from the client.", collocation: "submit a request / make a request / request assistance", audio: "/audio/unit31/request.mp3" },
    { id: 3, word: "inform", emoji: "📢", phonetic: "/ɪnˈfɔːm/", meaning: "thông báo / cho biết", example: "I regret to inform you that your application was unsuccessful.", example2: "Please inform us of any changes to your schedule.", collocation: "inform someone of / keep someone informed / write to inform", audio: "/audio/unit31/inform.mp3" },
    { id: 4, word: "clarify", emoji: "🔍", phonetic: "/ˈklærɪfaɪ/", meaning: "làm rõ / giải thích rõ", example: "Could you clarify the third point in the proposal?", example2: "We need to clarify our goals before starting the project.", collocation: "clarify a point / clarify the situation / need to clarify", audio: "/audio/unit31/clarify.mp3" },
    { id: 5, word: "recommend", emoji: "👍", phonetic: "/ˌrekəˈmend/", meaning: "khuyến nghị / khuyên", example: "We recommend that the company invest in new technology.", example2: "She recommended hiring an assistant.", collocation: "highly recommend / recommend that / recommend doing", audio: "/audio/unit31/recommend.mp3" , l1_interference_vn: "⚠️ Sau 'recommend': Ving hoặc that-clause. 'I recommend trying' hoặc 'recommend that you try'." },
    { id: 6, word: "advise", emoji: "👨‍💼", phonetic: "/ədˈvaɪz/", meaning: "khuyên / cố vấn", example: "The legal team advised us not to sign the contract yet.", example2: "I would advise caution in this business deal.", collocation: "advise someone to do / advise against / legal adviser", audio: "/audio/unit31/advise.mp3" },
    { id: 7, word: "agenda", emoji: "📋", phonetic: "/əˈdʒendə/", meaning: "chương trình họp / nội dung thảo luận", example: "What is the next item on the meeting agenda?", example2: "The main agenda today is the marketing plan.", collocation: "meeting agenda / set the agenda / top of the agenda", audio: "/audio/unit31/agenda.mp3" },
    { id: 8, word: "proposal", emoji: "📂", phonetic: "/prəˈpəʊzəl/", meaning: "bản đề xuất / kế hoạch", example: "We have submitted a proposal for the project.", example2: "The board rejected the business proposal.", collocation: "project proposal / submit a proposal / review a proposal", audio: "/audio/unit31/proposal.mp3" },
    { id: 9, word: "attachment", emoji: "📎", phonetic: "/əˈtætʃmənt/", meaning: "tệp đính kèm", example: "Please review the attachment for details.", example2: "I forgot to open the email attachment.", collocation: "email attachment / send an attachment / see attachment", audio: "/audio/unit31/attachment.mp3" },
    { id: 10, word: "delay", emoji: "⏳", phonetic: "/dɪˈleɪ/", meaning: "sự chậm trễ / trì hoãn", example: "The train delay caused me to miss the meeting.", example2: "We apologize for the delay in delivery.", collocation: "cause a delay / project delay / apologize for the delay", audio: "/audio/unit31/delay.mp3" , l1_interference_vn: "⚠️ 'The flight is delayed' (bị động). Stress: de-LAY (âm 2). 'A 3-hour delay' (danh từ)." },
    { id: 11, word: "deadline", emoji: "🏁", phonetic: "/ˈdedlaɪn/", meaning: "hạn chót / thời hạn cuối", example: "We must work hard to meet the project deadline.", example2: "The deadline for submission is next Friday.", collocation: "meet a deadline / miss a deadline / strict deadline", audio: "/audio/unit31/deadline.mp3" },
    { id: 12, word: "corporate", emoji: "🏢", phonetic: "/ˈkɔːpərət/", meaning: "thuộc doanh nghiệp / tập đoàn", example: "She is climbing the corporate ladder rapidly.", example2: "The company has a strong corporate culture.", collocation: "corporate client / corporate culture / corporate strategy", audio: "/audio/unit31/corporate.mp3" },
  ],
  dialogues: [
    {
      id: 1,
      title: "Soạn thảo email gửi đối tác",
      audio: "/audio/unit31/dialogue_1.mp3",
      desc: "Trọng và sếp thảo luận về email phản hồi việc trễ hạn chót.",
      lines: [
        { id: "d1-1", speaker: "Manager", text: "Trong, did we inform the corporate client about the project delay?", translation: "Trọng, chúng ta đã thông báo cho khách hàng doanh nghiệp về việc chậm trễ dự án chưa?" },
        { id: "d1-2", speaker: "Trong", text: "Yes, I am drafting an email now. I apologize for the delay and clarify the reasons.", translation: "Vâng, tôi đang soạn nháp email đây. Tôi xin lỗi vì sự chậm trễ và làm rõ các lý do." },
        { id: "d1-3", speaker: "Manager", text: "What do you propose regarding the new deadline?", translation: "Cậu đề xuất gì liên quan đến hạn chót mới?" },
        { id: "d1-4", speaker: "Trong", text: "I recommend that we extend the deadline by two weeks. I will also attach the revised proposal.", translation: "Tôi kiến nghị chúng ta kéo dài hạn chót thêm hai tuần. Tôi cũng sẽ đính kèm bản đề xuất đã sửa đổi." },
        { id: "d1-5", speaker: "Manager", text: "Good. Please request that they confirm their availability for a meeting on Thursday to set the new agenda.", translation: "Tốt. Hãy yêu cầu họ xác nhận sự có mặt cho một cuộc họp vào thứ Năm để thiết lập chương trình họp mới." },
      ],
    },
    {
      id: 2,
      title: "Yêu cầu tài liệu hỗ trợ",
      audio: "/audio/unit31/dialogue_2.mp3",
      desc: "Hội thoại qua điện thoại yêu cầu tệp đính kèm.",
      lines: [
        { id: "d2-1", speaker: "Alice", text: "Hello, I am calling to request the contract attachment.", translation: "Xin chào, tôi gọi điện để yêu cầu tệp đính kèm hợp đồng." },
        { id: "d2-2", speaker: "Trong", text: "Sure, let me check. I advise you to review the terms carefully before signing.", translation: "Chắc chắn rồi, để tôi kiểm tra. Tôi khuyên chị nên xem xét kỹ các điều khoản trước khi ký." },
        { id: "d2-3", speaker: "Alice", text: "Thank you. Please confirm once you have sent it.", translation: "Cảm ơn cậu. Vui lòng xác nhận một khi cậu đã gửi nó." },
      ],
    },
  ],
  listenAndChoose: [
    ...
    { id: "lac3", audio_text: "Please find the attached proposal for your review.", options: ["Please delete the proposal immediately.", "Please find the attached proposal for your review.", "I have sent the physical contract by post.", "The agenda of the meeting is not attached."], answer: "Please find the attached proposal for your review." },
  ...
  grammar: {
    ...
    examples: [
      { en: "I suggest that she send the email today. (subjunctive: 'send' instead of 'sends')", vn: "Tôi đề xuất cô ấy gửi email trong ngày hôm nay." },
    ...
    dialogueExample: {
      ...
      translation: "Tôi kiến nghị chúng ta kéo dài hạn chót thêm hai tuần. Tôi cũng sẽ đính kèm bản đề xuất đã sửa đổi.",
      highlight: "recommend that we extend (recommend + that clause + subjunctive mood)",
    },
    ccq: {
  ...
  practiceQuiz: [
    ...
    { id: "pq3", type: "cloze", question: "Điền: 'He suggested ___ (attach) the file to the email.'", answer: "attaching" },
  ...
  fluencyDrill: {
    items: [
      ...
      { en: "I am writing to confirm our meeting", vn: "Tôi viết thư để xác nhận cuộc họp" },
      { en: "We apologize for the delay", vn: "Chúng tôi xin lỗi vì sự chậm trễ" },
      { en: "Please inform us of changes", vn: "Vui lòng thông báo cho chúng tôi về thay đổi" },
      { en: "The deadline is next Friday", vn: "Hạn chót là thứ Sáu tới" },
      { en: "We recommend that you sign", vn: "Chúng tôi khuyên bạn nên ký" },
      { en: "Could you clarify this point?", vn: "Bạn có thể làm rõ điểm này không?" },
