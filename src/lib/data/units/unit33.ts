...
export const unit33: UnitData = {
  ...
  vocab: [
    { id: 1, word: "hypothetical", emoji: "💭", phonetic: "/ˌhaɪpəˈθetɪkəl/", meaning: "mang tính giả định / giả thuyết", example: "Let's look at a hypothetical situation to understand this rule.", example2: "This is a purely hypothetical question.", collocation: "hypothetical situation / hypothetical question / purely hypothetical", audio: "/audio/unit33/hypothetical.mp3", l1_interference_vn: "⚠️ VN hay nhầm 'hypothetical' với thì hiện tại. Trong second conditional: 'If + past simple (were), ... would'. KHÔNG dùng will." },
    { id: 2, word: "scenario", emoji: "🎬", phonetic: "/sɪˈnɑːriəʊ/", meaning: "kịch bản / tình huống có thể xảy ra", example: "We must prepare for the worst-case scenario.", example2: "In this scenario, we would lose half of our users.", collocation: "worst-case scenario / likely scenario / best-case scenario", audio: "/audio/unit33/scenario.mp3", l1_interference_vn: "⚠️ 'In this scenario, we would...' (giả định). VN hay dùng 'will' vì nghĩ 'có thể xảy ra'. Second cond luôn lùi thì + would." },
    { id: 3, word: "assume", emoji: "🤔", phonetic: "/əˈsjuːm/", meaning: "giả định / tự cho là", example: "If we assume that the market is stable, this plan will work.", example2: "Do not assume that everyone agrees with you.", collocation: "assume responsibility / assume that / let's assume", audio: "/audio/unit33/assume.mp3", l1_interference_vn: "⚠️ 'Assume' + that clause trong giả định hay bị VN thêm 'will': đúng là 'If we assume..., we would...'. Lùi thì sau If." },
    { id: 4, word: "imagine", emoji: "🎨", phonetic: "/ɪˈmædʒɪn/", meaning: "tưởng tượng", example: "Imagine what you would do if you won the lottery.", example2: "I can't imagine living in a cold country.", collocation: "imagine that / hard to imagine / imagine doing", audio: "/audio/unit33/imagine.mp3", l1_interference_vn: "⚠️ 'Imagine if...' dùng để dẫn second conditional. VN hay 'Imagine you win' (sai thì). Phải: 'if you won' (past)." },
    { id: 5, word: "venture", emoji: "🚀", phonetic: "/ˈventʃər/", meaning: "dự án kinh doanh mạo hiểm / đầu tư mạo hiểm", example: "Their new business venture proved to be highly profitable.", example2: "They are seeking funding for a joint venture.", collocation: "business venture / joint venture / venture capital", audio: "/audio/unit33/venture.mp3", l1_interference_vn: "⚠️ 'Venture' (dự án mạo hiểm) hay nhầm với 'adventure'. Collocation đúng: 'business venture', không 'business adventure'." },
    { id: 6, word: "invest", emoji: "💰", phonetic: "/ɪnˈvest/", meaning: "đầu tư", example: "If we had capital, we would invest in artificial intelligence.", example2: "The company invested heavily in research.", collocation: "invest in / invest money / invest time", audio: "/audio/unit33/invest.mp3", l1_interference_vn: "⚠️ Đừng dịch 'invest' theo nghĩa đen từng từ — học theo collocation trong ví dụ." },
    { id: 7, word: "expansion", emoji: "📈", phonetic: "/ɪkˈspænʃən/", meaning: "sự mở rộng / phát triển", example: "The corporate expansion created hundreds of new jobs.", example2: "We are planning our international expansion next year.", collocation: "business expansion / rapid expansion / global expansion", audio: "/audio/unit33/expansion.mp3", l1_interference_vn: "⚠️ 'Expansion' (sự mở rộng) — VN hay bỏ mạo từ 'the' trước danh từ trừu tượng: 'the expansion' khi nói cụ thể. 'Corporate expansion' cần article khi chỉ cái đã biết." },
    { id: 8, word: "outcome", emoji: "🎯", phonetic: "/ˈaʊtkʌm/", meaning: "kết quả / đầu ra", example: "What is the expected outcome of the negotiation?", example2: "We are very pleased with the final outcome.", collocation: "expected outcome / final outcome / positive outcome", audio: "/audio/unit33/outcome.mp3", l1_interference_vn: "⚠️ 'Outcome of' đúng collocation. VN hay 'result from' hoặc 'consequence from' — dùng 'of' cho outcome/result trong ngữ cảnh dự án." },
    { id: 9, word: "risk", emoji: "⚡", phonetic: "/rɪsk/", meaning: "rủi ro", example: "Starting a new venture always involves a high level of risk.", example2: "If we took that risk, we might lose our investment.", collocation: "take a risk / reduce risk / risk assessment", audio: "/audio/unit33/risk.mp3", l1_interference_vn: "⚠️ 'Take a risk' (nhận rủi ro). VN hay 'do risk' hoặc 'risky something'. Collocation chuẩn: take/run a risk; assess risk." },
    { id: 10, word: "criteria", emoji: "📋", phonetic: "/kraɪˈtɪəriə/", meaning: "tiêu chí (số nhiều của criterion)", example: "What are the criteria for selecting the candidate?", example2: "The project met all the evaluation criteria.", collocation: "selection criteria / evaluation criteria / meet the criteria", audio: "/audio/unit33/criteria.mp3", l1_interference_vn: "⚠️ 'Criteria' là số nhiều (criterion số ít). VN hay dùng 'criteria' như số ít hoặc quên 'the' : 'meet the criteria' (cần 'the' khi chỉ định)." },
    { id: 11, word: "assess", emoji: "🔍", phonetic: "/əˈses/", meaning: "đánh giá / định giá", example: "We need to assess the risks before making a decision.", example2: "The teacher will assess the students' speaking skills.", collocation: "assess risks / assess performance / assess the situation", audio: "/audio/unit33/assess.mp3", l1_interference_vn: "⚠️ 'Assess the risks' — VN hay 'evaluate risk' đơn. Formal B2: 'assess' + plural cho nhiều rủi ro; dùng 'the' khi đã đề cập." },
