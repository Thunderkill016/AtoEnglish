...
export const unit9: UnitData = {
  ...
  vocab: [
    ...
    { id: 3, word: "supermarket", emoji: "🛒", phonetic: "/ˈsuːpəmɑːkɪt/", meaning: "siêu thị", example: "The supermarket is between the bank and the café.", example2: "I go to the supermarket every week.", collocation: "local supermarket", audio: "/audio/unit9/supermarket.mp3", l1_interference_vn: "⚠️ 'At the supermarket' (đang ở đó) vs 'to the supermarket' (đi đến). Dùng 'at' khi nói địa điểm." },
    { id: 4, word: "park", emoji: "🌳", phonetic: "/pɑːk/", meaning: "công viên", example: "The park is near my house.", example2: "We like to walk in the park.", collocation: "city park / national park", audio: "/audio/unit9/park.mp3", l1_interference_vn: "⚠️ 'Park' (n) = công viên. 'Park' (v) = đỗ xe. 'In the park' (trong công viên) vs 'park the car' (đỗ xe)." },
    { id: 5, word: "school", emoji: "🏫", phonetic: "/skuːl/", meaning: "trường học", example: "The school is next to the library.", example2: "My sister goes to that school.", collocation: "primary school / go to school", audio: "/audio/unit9/school.mp3", l1_interference_vn: "⚠️ 'At school' (không có 'the') = đang học/đi học. 'At the school' = tại tòa nhà. Tương tự: 'at home', 'in hospital'." },
    { id: 6, word: "post office", emoji: "📮", phonetic: "/pəʊst ˈɒfɪs/", meaning: "bưu điện", example: "Is there a post office near here?", example2: "I sent a letter at the post office.", collocation: "local post office", audio: "/audio/unit9/post_office.mp3", l1_interference_vn: "⚠️ 'At the post office'. 'Go to the post office'. Hai từ riêng: 'post office', không phải 'postoffice'." },
    { id: 7, word: "next to", emoji: "↔️", phonetic: "/nɛkst tə/", meaning: "cạnh bên / kế bên", example: "The café is next to the bank.", example2: "My house is next to the park.", collocation: "right next to", audio: "/audio/unit9/next_to.mp3", l1_interference_vn: "⚠️ 'Next to' = cạnh bên (tiếp xúc hoặc rất gần). 'Near' = gần (không nhất thiết sát). KHÔNG 'next of'." },
    { id: 8, word: "opposite", emoji: "⬅️➡️", phonetic: "/ˈɒpəzɪt/", meaning: "đối diện", example: "The hospital is opposite the school.", example2: "The bus stop is opposite the supermarket.", collocation: "directly opposite", audio: "/audio/unit9/opposite.mp3", l1_interference_vn: "⚠️ 'Opposite the bank' — giới từ sau 'opposite' KHÔNG cần 'to'. KHÔNG 'opposite to the bank' (sai)." },
    { id: 9, word: "between", emoji: "🔀", phonetic: "/bɪˈtwiːn/", meaning: "giữa (hai thứ)", example: "The park is between the bank and the school.", example2: "Our office is between two big buildings.", collocation: "between...and...", audio: "/audio/unit9/between.mp3", l1_interference_vn: "⚠️ 'Between A and B' (hai thứ). 'Among' dùng cho 3+ thứ. KHÔNG 'between three things' — dùng 'among'." },
    { id: 10, word: "turn left", emoji: "⬅️", phonetic: "/tɜːn lɛft/", meaning: "rẽ trái", example: "Turn left at the traffic light.", example2: "Turn left and you will see the hotel.", collocation: "turn left at the corner", audio: "/audio/unit9/turn_left.mp3" , l1_interference_vn: "⚠️ Âm cuối /ft/ trong 'left' — đừng đọc 'lep' hay 'lef'. Luyện: left, lift, soft." },
