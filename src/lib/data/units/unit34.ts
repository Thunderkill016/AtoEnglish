...
export const unit34: UnitData = {
  ...
  vocab: [
    { id: 1, word: "regret", emoji: "😢", phonetic: "/rɪˈɡret/", meaning: "sự hối tiếc / hối tiếc", example: "I deeply regret not attending the training session last month.", example2: "My greatest regret is that we didn't launch the project earlier.", collocation: "express regret / deep regret / feel regret", audio: "/audio/unit34/regret.mp3", l1_interference_vn: "⚠️ Đừng dịch 'word' theo nghĩa đen từng từ — học theo collocation trong ví dụ." },
    { id: 2, word: "reflection", emoji: "🧘", phonetic: "/rɪˈflekʃən/", meaning: "sự suy ngẫm / phản chiếu", example: "Upon reflection, I realize we made several wrong decisions.", example2: "The report is a clear reflection of our team's effort.", collocation: "upon reflection / self-reflection / written reflection", audio: "/audio/unit34/reflection.mp3", l1_interference_vn: "⚠️ Người Việt hay bỏ mạo từ 'the/a' trước 'reflection' trong câu trang trọng." },
    { id: 3, word: "evaluation", emoji: "📊", phonetic: "/ɪˌvæljuˈeɪʃən/", meaning: "sự đánh giá / nhận định", example: "The company conducted a thorough evaluation of the campaign.", example2: "Performance evaluation is done at the end of each year.", collocation: "project evaluation / performance evaluation / final evaluation", audio: "/audio/unit34/evaluation.mp3", l1_interference_vn: "⚠️ 'evaluation' thường đi với giới từ cố định — xem collocation, không dùng 'of/for' tùy tiện." },
    { id: 4, word: "overlook", emoji: "🙈", phonetic: "/ˌəʊvəˈlʊk/", meaning: "bỏ sót / bỏ qua (lỗi)", example: "We cannot afford to overlook even the smallest error.", example2: "The manager overlooked her lateness because she worked hard.", collocation: "overlook a mistake / overlook an error / completely overlook", audio: "/audio/unit34/overlook.mp3", l1_interference_vn: "⚠️ Phát âm cuối âm tiết của 'overlook' rõ (/s/, /t/, /d/) — IELTS speaking." },
    { id: 5, word: "foresee", emoji: "🔮", phonetic: "/fɔːˈsiː/", meaning: "nhìn thấy trước / dự đoán trước", example: "No one could foresee the economic crisis at that time.", example2: "If we had foreseen the delay, we would have changed the plan.", collocation: "foresee the future / foresee risks / foresee problems", audio: "/audio/unit34/foresee.mp3", l1_interference_vn: "⚠️ 'foresee' là danh từ không đếm được hoặc đếm được — không thêm 's' sai ngữ cảnh." },
    { id: 6, word: "investigate", emoji: "🕵️", phonetic: "/ɪnˈvestɪɡeɪt/", meaning: "điều tra / tìm hiểu kỹ", example: "The IT team is investigating the server crash.", example2: "We must investigate the cause of the customer complaints.", collocation: "investigate the cause / thoroughly investigate / investigate the issue", audio: "/audio/unit34/investigate.mp3", l1_interference_vn: "⚠️ \'Investigate\' + N trực tiếp: \'investigate the case\'. \'Under investigation\' = đang bị điều tra." },
    { id: 7, word: "complication", emoji: "🌀", phonetic: "/ˌkɒmplɪˈkeɪʃən/", meaning: "sự rắc rối / phức tạp / biến chứng", example: "The project faced several complications during the testing phase.", example2: "We resolved the technical complications quickly.", collocation: "unexpected complication / cause complications / face complications", audio: "/audio/unit34/complication.mp3", l1_interference_vn: "⚠️ Third conditional: 'If we had..., we could have rectified the complication'. VN hay quên 'had' + V3 hoặc dùng present. Lùi 2 thì quá khứ." },
    { id: 8, word: "rectify", emoji: "🔧", phonetic: "/ˈrektɪfaɪ/", meaning: "khắc phục / sửa chữa (sai lầm)", example: "We must take immediate action to rectify this situation.", example2: "The error was rectified before the product launch.", collocation: "rectify a mistake / rectify the situation / rectify an error", audio: "/audio/unit34/rectify.mp3", l1_interference_vn: "⚠️ 'Rectify' trang trọng hơn 'fix'. VN hay 'correct the complication' . Third cond dùng 'could/would have rectified'." },
    { id: 9, word: "prevent", emoji: "🛑", phonetic: "/prɪˈvent/", meaning: "ngăn chặn / phòng ngừa", example: "Security measures were implemented to prevent data theft.", example2: "Nothing could prevent him from achieving his goals.", collocation: "prevent a problem / prevent damage / prevent from doing", audio: "/audio/unit34/prevent.mp3", l1_interference_vn: "⚠️ 'Prevent someone from doing' — VN hay quên 'from' hoặc dùng 'to'. 'Prevent + N + from + Ving'." },
    { id: 10, word: "fault", emoji: "⚠️", phonetic: "/fɔːlt/", meaning: "lỗi / trách nhiệm sai sót", example: "It was not my fault that the shipment was delayed.", example2: "The system crash was due to a technical fault.", collocation: "technical fault / find fault / it's my fault", audio: "/audio/unit34/fault.mp3", l1_interference_vn: "⚠️ 'It was not my fault' (không phải lỗi của tôi). VN hay 'It's not fault me'. Cấu trúc 'It is/was not + possessive + fault'." },
    { id: 11, word: "analysis", emoji: "📈", phonetic: "/əˈnæləsɪs/", meaning: "sự phân tích", example: "A detailed analysis of the market is required.", example2: "The team conducted a risk analysis before investing.", collocation: "data analysis / market analysis / conduct an analysis", audio: "/audio/unit34/analysis.mp3", l1_interference_vn: "⚠️ 'Analysis' số ít (analyses số nhiều). VN hay 'an analyses' sai. Third cond ví dụ: 'If we had done the analysis, ...' ." },
    { id: 12, word: "error", emoji: "❌", phonetic: "/ˈerər/", meaning: "sai sót / lỗi kỹ thuật", example: "The system displayed a system error code.", example2: "An error occurred during the file transfer.", collocation: "system error / human error / avoid errors", audio: "/audio/unit34/error.mp3", l1_interference_vn: "⚠️ 'Human error' vs 'technical fault'. VN hay lẫn 'error' với 'mistake' — 'error' dùng cho hệ thống, 'mistake' cá nhân." },
  ],
