...
export const unit13: UnitData = {
  ...
  vocab: [
    ...
    { id: 12, word: "business trip", emoji: "💼", phonetic: "/ˈbɪznəs trɪp/", meaning: "chuyến công tác", example: "I went on a business trip last month.", example2: "She is on a business trip to Singapore.", collocation: "go on a business trip", audio: "/audio/unit13/business_trip.mp3", l1_interference_vn: "⚠️ 'Business trip' = chuyến đi làm việc, không phải du lịch. 'On a trip'." },
  ],
