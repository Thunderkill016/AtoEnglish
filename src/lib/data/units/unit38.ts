...
export const unit38: UnitData = {
  ...
  vocab: [
    { id: 1, word: "persuasion", emoji: "🗣️", phonetic: "/pəˈsweɪʒən/", meaning: "sự thuyết phục", example: "She used all her powers of persuasion to convince the board.", example2: "The sales pitch was a masterclass in persuasion.", collocation: "powers of persuasion / gentle persuasion / political persuasion", audio: "/audio/unit38/persuasion.mp3", l1_interference_vn: "⚠️ Đừng dịch 'word' theo nghĩa đen từng từ — học theo collocation trong ví dụ." },
    { id: 2, word: "emphasis", emoji: "📌", phonetic: "/ˈemfəsɪs/", meaning: "sự nhấn mạnh / trọng tâm", example: "The company places great emphasis on customer satisfaction.", example2: "There is an emphasis on teamwork in our corporate culture.", collocation: "place emphasis on / strong emphasis / add emphasis", audio: "/audio/unit38/emphasis.mp3", l1_interference_vn: "⚠️ Người Việt hay bỏ mạo từ 'the/a' trước 'emphasis' trong câu trang trọng." },
    { id: 3, word: "debate", emoji: "🗣️", phonetic: "/dɪˈbeɪt/", meaning: "cuộc tranh luận / thảo luận công khai", example: "There has been a heated debate about the new tax policy.", example2: "We debated the issue for several hours before deciding.", collocation: "heated debate / debate about / public debate", audio: "/audio/unit38/debate.mp3", l1_interference_vn: "⚠️ 'debate' thường đi với giới từ cố định — xem collocation, không dùng 'of/for' tùy tiện." },
    { id: 4, word: "convince", emoji: "🤝", phonetic: "/kənˈvɪns/", meaning: "thuyết phục (ai đó tin vào điều gì)", example: "I managed to convince him that our strategy was correct.", example2: "She was convinced of his innocence.", collocation: "convince someone / convince that / highly convincing", audio: "/audio/unit38/convince.mp3", l1_interference_vn: "⚠️ Phát âm cuối âm tiết của 'convince' rõ (/s/, /t/, /d/) — IELTS speaking." },
    { id: 5, word: "advocate", emoji: "📢", phonetic: "/ˈædvəkeɪt/", meaning: "ủng hộ / người ủng hộ / luật sư bào chữa", example: "The group advocates for the protection of human rights.", example2: "She is a strong advocate of renewable energy.", collocation: "advocate of / strongly advocate / patient advocate", audio: "/audio/unit38/advocate.mp3", l1_interference_vn: "⚠️ 'advocate' là danh từ không đếm được hoặc đếm được — không thêm 's' sai ngữ cảnh." },
    { id: 6, word: "dominate", emoji: "👑", phonetic: "/ˈdɒmɪneɪt/", meaning: "thống trị / chiếm ưu thế / lấn át", example: "The multinational corporation dominates the local market.", example2: "Men continue to dominate the technology sector.", collocation: "dominate the market / dominate the conversation / dominant position", audio: "/audio/unit38/dominate.mp3", l1_interference_vn: "⚠️ Trong email B2, 'dominate' đứng trong cụm trang trọng — tránh cấu trúc câu kiểu tiếng Việt." },
    { id: 7, word: "leverage", emoji: "📈", phonetic: "/ˈliːvərɪdʒ/", meaning: "tận dụng / lực đòn bẩy", example: "We should leverage our brand reputation to enter new markets.", example2: "The company leveraged its assets to secure the loan.", collocation: "leverage technology / leverage resources / maximum leverage", audio: "/audio/unit38/leverage.mp3", l1_interference_vn: "⚠️ 'Leverage' trong business mang nghĩa tích cực tận dụng lợi thế. Hay bị dịch sai thành 'mượn' hoặc 'tăng'." },
    ...
    { id: 10, word: "logic", emoji: "🧠", phonetic: "/ˈlɒdʒɪk/", meaning: "lập luận / logic", example: "I don't understand the logic behind this decision.", example2: "His argument lacks logical structure.", collocation: "business logic / lack logic / logical reasoning", audio: "/audio/unit38/logic.mp3", l1_interference_vn: "⚠️ 'The logic behind' = lý do đằng sau. Người VN hay nói 'logic của quyết định' thiếu giới từ." },
    ...
    { id: 12, word: "influence", emoji: "🌟", phonetic: "/ˈɪnfluəns/", meaning: "sự ảnh hưởng / ảnh hưởng đến", example: "His speech had a profound influence on the audience.", example2: "We want to influence consumer behavior through advertising.", collocation: "have an influence on / under the influence / positive influence", audio: "/audio/unit38/influence.mp3", l1_interference_vn: "⚠️ 'Have an influence on' (cụm cố định). Dùng 'affect' cho động từ tác động trực tiếp." },
  ],
