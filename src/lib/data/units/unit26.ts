...
export const unit26: UnitData = {
  ...
  vocab: [
    ...
    { id: 3, word: "avoid", emoji: "🚫", phonetic: "/əˈvɔɪd/", meaning: "tránh", example: "Try to avoid making the same mistake twice.", example2: "She avoids attending unnecessary meetings.", collocation: "avoid conflict / avoid mistakes / avoid doing", audio: "/audio/unit26/avoid.mp3", l1_interference_vn: "⚠️ \'Avoid + V-ING\': \'avoid making mistakes\'. SAI: \'avoid to make mistakes\'." },
    ...
    { id: 8, word: "propose", emoji: "📋", phonetic: "/prəˈpəʊz/", meaning: "đề nghị / đề xuất", example: "She proposed restructuring the entire team.", example2: "I'd like to propose a different approach.", collocation: "propose a solution / formally propose / proposal", audio: "/audio/unit26/propose.mp3", l1_interference_vn: "⚠️ + V-ing hoặc that-clause: \'propose doing sth\'. KHÔNG dùng \'propose to do\' theo nghĩa gợi ý." },
