...
export const unit17: UnitData = {
  ...
  vocab: [
    ...
    { id: 3, word: "never", emoji: "❌", phonetic: "/ˈnevər/", meaning: "chưa bao giờ", example: "I have never been to Europe.", example2: "She has never tried Vietnamese coffee.", collocation: "have never / never before", audio: "/audio/unit17/never.mp3" , l1_interference_vn: "⚠️ 'I've NEVER been' — vị trí giữa have và V3. 'Haven't never' = double negative — SAI." },
    { id: 4, word: "already", emoji: "✅", phonetic: "/ɔːlˈredi/", meaning: "đã (rồi)", example: "I've already sent the report.", example2: "She has already left the office.", collocation: "have already / already done", audio: "/audio/unit17/already.mp3" , l1_interference_vn: "⚠️ Vị trí: giữa 'have' và V3: 'I've ALREADY done it'. Cuối câu cũng đúng." },
    { id: 5, word: "yet", emoji: "⏳", phonetic: "/jet/", meaning: "chưa / rồi chưa (trong câu hỏi)", example: "Have you finished yet?", example2: "I haven't replied yet.", collocation: "not yet / have you... yet", audio: "/audio/unit17/yet.mp3" , l1_interference_vn: "⚠️ 'Yet' trong câu phủ định/hỏi, cuối câu: 'Have you eaten yet?' / 'I haven't eaten yet'." },
    { id: 6, word: "just", emoji: "⚡", phonetic: "/dʒʌst/", meaning: "vừa mới", example: "I've just arrived at the office.", example2: "She has just sent the email.", collocation: "have just / just finished", audio: "/audio/unit17/just.mp3" , l1_interference_vn: "⚠️ 'I've JUST arrived' — 'just' giữa have và V3. Nghĩa: vừa mới xong (rất gần đây)." },
    { id: 7, word: "achieve", emoji: "🏆", phonetic: "/əˈtʃiːv/", meaning: "đạt được", example: "She has achieved excellent results.", example2: "I've achieved my sales target.", collocation: "achieve a goal / achieve results", audio: "/audio/unit17/achieve.mp3" , l1_interference_vn: "⚠️ Stress: a-CHIEVE (âm 2). Âm /tʃ/ trong '-chieve'. 'Achieve a goal' — không 'reach a goal'." },
    { id: 8, word: "since", emoji: "📅", phonetic: "/sɪns/", meaning: "từ khi (mốc thời gian)", example: "I've worked here since 2020.", example2: "She has lived in Hanoi since she was a child.", collocation: "since then / since last year", audio: "/audio/unit17/since.mp3" , l1_interference_vn: "⚠️ 'Since' + mốc thời gian: 'since 2020'. 'For' + khoảng thời gian: 'for 3 years'. Hay nhầm." },
    { id: 9, word: "for", emoji: "⏱️", phonetic: "/fɔːr/", meaning: "trong (khoảng thời gian)", example: "I've lived here for five years.", example2: "We've been partners for a long time.", collocation: "for years / for a long time", audio: "/audio/unit17/for.mp3" , l1_interference_vn: "⚠️ 'For 5 years' (present perfect duration). Không nhầm với 'since 2020' (mốc thời gian)." },
    { id: 10, word: "recently", emoji: "🕐", phonetic: "/ˈriːsəntli/", meaning: "gần đây", example: "I've recently started learning Spanish.", example2: "Have you read any good books recently?", collocation: "recently completed / recently joined", audio: "/audio/unit17/recently.mp3" , l1_interference_vn: "⚠️ Thường dùng với present perfect: 'I've recently moved'. Ít dùng với past simple." },
