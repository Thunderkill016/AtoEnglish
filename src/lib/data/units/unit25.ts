...
export const unit25: UnitData = {
  ...
  vocab: [
    ...
    { id: 3, word: "qualified", emoji: "🎓", phonetic: "/ˈkwɒlɪfaɪd/", meaning: "có trình độ / đủ tiêu chuẩn", example: "We need a qualified engineer who has at least five years of experience.", example2: "She is highly qualified for the position.", collocation: "highly qualified / qualified professional / well qualified", audio: "/audio/unit25/qualified.mp3", l1_interference_vn: "⚠️ \'Qualified FOR\' hoặc \'qualified TO DO\': \'qualified for the job\'. Không dùng \'qualified in doing\'." },
    { id: 4, word: "specialist", emoji: "🧑‍🔬", phonetic: "/ˈspeʃəlɪst/", meaning: "chuyên gia", example: "Dr. Minh is the specialist who developed our AI system.", example2: "We brought in a specialist to solve the technical problem.", collocation: "IT specialist / marketing specialist / subject specialist", audio: "/audio/unit25/specialist.mp3", l1_interference_vn: "⚠️ \'Specialist IN\': \'a specialist in oncology\'. Giới từ \'in\'. Tương tự \'expert in\'." },
    ...
    { id: 6, word: "remote", emoji: "🌐", phonetic: "/rɪˈməʊt/", meaning: "từ xa", example: "We have team members who work remotely from across Southeast Asia.", example2: "Remote work has become standard in our industry.", collocation: "remote work / remote team / work remotely", audio: "/audio/unit25/remote.mp3", l1_interference_vn: "⚠️ \'Remote work\' = làm việc từ xa (tính từ). \'Work remotely\' (trạng từ). Không dùng \'remote\' như danh từ." },
    ...
    { id: 10, word: "client", emoji: "👥", phonetic: "/ˈklaɪənt/", meaning: "khách hàng", example: "The client whose contract we signed last week is very satisfied.", example2: "Our biggest client is based in Singapore.", collocation: "key client / client base / serve clients", audio: "/audio/unit25/client.mp3", l1_interference_vn: "⚠️ = khách hàng dịch vụ chuyên nghiệp. Phân biệt \'customer\' (mua hàng hóa)." },
