...
export const unit8: UnitData = {
  ...
  vocab: [
    ...
    { id: 3, word: "bread", emoji: "🍞", phonetic: "/brɛd/", meaning: "bánh mì", example: "I have bread and butter for breakfast.", example2: "Would you like some bread?", collocation: "slice of bread", audio: "/audio/unit8/bread.mp3", l1_interference_vn: "⚠️ 'Bread' không đếm được. 'A loaf of bread', 'a slice of bread'. KHÔNG 'a bread' hay 'two breads'." },
    { id: 4, word: "chicken", emoji: "🍗", phonetic: "/ˈtʃɪkɪn/", meaning: "thịt gà", example: "I'd like some chicken, please.", example2: "The chicken soup is very good.", collocation: "grilled chicken", audio: "/audio/unit8/chicken.mp3", l1_interference_vn: "⚠️ 'Chicken' (thịt, uncountable) vs 'a chicken' (con gà). 'I eat chicken' (thịt) vs 'I have a chicken' (nuôi)." },
    { id: 5, word: "vegetable", emoji: "🥦", phonetic: "/ˈvedʒtəbəl/", meaning: "rau củ", example: "Eat your vegetables!", example2: "I like fresh vegetables.", collocation: "fresh vegetables", audio: "/audio/unit8/vegetable.mp3", l1_interference_vn: "⚠️ 'Vegetables' (số nhiều) khi nói chung: 'I eat vegetables'. Một loại cụ thể: 'a carrot', 'some spinach'." },
    { id: 6, word: "fruit", emoji: "🍎", phonetic: "/fruːt/", meaning: "hoa quả", example: "I eat fruit every morning.", example2: "There is some fruit on the table.", collocation: "fresh fruit / tropical fruit", audio: "/audio/unit8/fruit.mp3", l1_interference_vn: "⚠️ 'Fruit' (uncountable khi nói chung): 'I eat fruit'. Đếm được khi chỉ loại cụ thể: 'two fruits' = hai loại trái cây." },
    { id: 7, word: "water", emoji: "💧", phonetic: "/ˈwɔːtər/", meaning: "nước", example: "Can I have some water?", example2: "Drink eight glasses of water a day.", collocation: "a glass of water / mineral water", audio: "/audio/unit8/water.mp3", l1_interference_vn: "⚠️ 'Water' không đếm được. 'A glass/bottle of water'. 'Some water'. KHÔNG 'a water' hay 'two waters' (trừ khi đặt hàng)." },
    { id: 8, word: "coffee", emoji: "☕", phonetic: "/ˈkɒfi/", meaning: "cà phê", example: "I drink coffee in the morning.", example2: "Do you want some coffee?", collocation: "black coffee / iced coffee", audio: "/audio/unit8/coffee.mp3", l1_interference_vn: "⚠️ 'Coffee' (uncountable) nhưng khi đặt: 'two coffees' = hai ly cà phê. 'A cup of coffee' là cách nói chuẩn." },
    { id: 9, word: "soup", emoji: "🍲", phonetic: "/suːp/", meaning: "súp", example: "This soup is delicious.", example2: "I'd like a bowl of soup.", collocation: "bowl of soup / chicken soup", audio: "/audio/unit8/soup.mp3", l1_interference_vn: "⚠️ 'Soup' (uncountable): 'a bowl of soup'. Trong nhà hàng có thể nói 'two soups'. KHÔNG 'a soup bowl'." },
    { id: 10, word: "dessert", emoji: "🍮", phonetic: "/dɪˈzɜːt/", meaning: "món tráng miệng", example: "What would you like for dessert?", example2: "I love chocolate dessert.", collocation: "for dessert", audio: "/audio/unit8/dessert.mp3", l1_interference_vn: "⚠️ 'Dessert' /dɪˈzɜːrt/ (món tráng miệng) ≠ 'desert' /ˈdezərt/ (sa mạc). Một 's' vs hai 's' — lỗi phổ biến!" },
