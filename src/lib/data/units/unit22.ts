...
export const unit22: UnitData = {
  ...
  vocab: [
    ...
    { id: 3, word: "comply", emoji: "🤝", phonetic: "/kəmˈplaɪ/", meaning: "tuân thủ", example: "All staff must comply with the company's code of conduct.", example2: "Failure to comply will result in disciplinary action.", collocation: "comply with / compliance with / non-compliance", audio: "/audio/unit22/comply.mp3", l1_interference_vn: "⚠️ \'Comply WITH\': \'comply with the regulations\'. Bắt buộc giới từ \'with\'." },
    { id: 4, word: "policy", emoji: "📄", phonetic: "/ˈpɒlɪsi/", meaning: "chính sách", example: "According to company policy, all expenses must be approved.", example2: "Our policy is to respond to clients within 24 hours.", collocation: "company policy / follow a policy / implement a policy", audio: "/audio/unit22/policy.mp3", l1_interference_vn: "⚠️ Đếm được: \'a policy\', \'policies\'. Không nhầm với \'politics\' (chính trị — ngành học)." },
    { id: 5, word: "obligation", emoji: "⚖️", phonetic: "/ˌɒblɪˈɡeɪʃən/", meaning: "nghĩa vụ / bổn phận", example: "You have an obligation to report any safety hazards.", example2: "There is no obligation to sign the contract today.", collocation: "legal obligation / fulfil an obligation / under no obligation", audio: "/audio/unit22/obligation.mp3", l1_interference_vn: "⚠️ \'Obligation TO DO\': \'have an obligation to help\'. Giới từ \'to\', không phải \'of doing\'." },
    { id: 6, word: "enforce", emoji: "🔒", phonetic: "/ɪnˈfɔːs/", meaning: "thực thi / áp dụng", example: "The company strictly enforces its data privacy policy.", example2: "Laws are meaningless if they are not enforced.", collocation: "enforce the rules / strictly enforce / law enforcement", audio: "/audio/unit22/enforce.mp3", l1_interference_vn: "⚠️ \'Enforce\' + N: \'enforce the law\'. Không dùng \'enforce to do\'." },
    { id: 7, word: "violate", emoji: "❌", phonetic: "/ˈvaɪəleɪt/", meaning: "vi phạm", example: "You must not violate the confidentiality agreement.", example2: "The company was fined for violating safety standards.", collocation: "violate a rule / violate a contract / violation", audio: "/audio/unit22/violate.mp3", l1_interference_vn: "⚠️ + N trực tiếp: \'violate the law/rules\'. Không cần giới từ sau \'violate\'." },
    { id: 8, word: "penalty", emoji: "💸", phonetic: "/ˈpenəlti/", meaning: "hình phạt / tiền phạt", example: "There is a penalty for late submission of tax returns.", example2: "The penalty for non-compliance can be severe.", collocation: "face a penalty / financial penalty / impose a penalty", audio: "/audio/unit22/penalty.mp3", l1_interference_vn: "⚠️ \'Penalty FOR\': \'a penalty for breaking the law\'. Giới từ \'for\', không phải \'of\'." },
    { id: 9, word: "procedure", emoji: "🔄", phonetic: "/prəˈsiːdʒər/", meaning: "quy trình / thủ tục", example: "You should follow the correct procedure for expense claims.", example2: "The standard procedure takes about three working days.", collocation: "standard procedure / follow a procedure / safety procedure", audio: "/audio/unit22/procedure.mp3", l1_interference_vn: "⚠️ \'Procedure FOR + V-ING\': \'the procedure for applying\'. Số nhiều: \'follow the procedures\'." },
