...
export const unit21: UnitData = {
  ...
  vocab: [
    ...
    { id: 2, word: "trend", emoji: "📈", phonetic: "/trend/", meaning: "xu hướng", example: "The trend towards remote work will continue.", example2: "We need to respond to emerging market trends.", collocation: "current trend / emerging trend / follow a trend", audio: "/audio/unit21/trend.mp3" },
    { id: 3, word: "sustainable", emoji: "🌱", phonetic: "/səˈsteɪnəbəl/", meaning: "bền vững", example: "By 2030, our operations will be fully sustainable.", example2: "Sustainable energy is no longer optional for businesses.", collocation: "sustainable development / sustainable growth", audio: "/audio/unit21/sustainable.mp3" },
    ...
    { id: 5, word: "transform", emoji: "🔄", phonetic: "/trænsˈfɔːm/", meaning: "chuyển đổi / biến đổi", example: "AI will have transformed the industry by 2030.", example2: "Digital tools are transforming how we work.", collocation: "transform the industry / digital transformation", audio: "/audio/unit21/transform.mp3" },
    ...
    { id: 7, word: "revenue", emoji: "💰", phonetic: "/ˈrevənjuː/", meaning: "doanh thu", example: "By Q3, we will have reached our revenue target.", example2: "Revenue is expected to double within two years.", collocation: "annual revenue / revenue growth / generate revenue", audio: "/audio/unit21/revenue.mp3" },
    { id: 8, word: "sector", emoji: "🏭", phonetic: "/ˈsektər/", meaning: "lĩnh vực / ngành", example: "The technology sector will be leading growth in 2025.", example2: "She works in the financial sector.", collocation: "private sector / public sector / tech sector", audio: "/audio/unit21/sector.mp3" },
    ...
    { id: 10, word: "competition", emoji: "⚔️", phonetic: "/ˌkɒmpəˈtɪʃən/", meaning: "cạnh tranh", example: "Competition will be increasing as new players enter.", example2: "The competition in this market is fierce.", collocation: "fierce competition / face competition / competitive market", audio: "/audio/unit21/competition.mp3" },
    ...
    { id: 12, word: "disrupt", emoji: "💥", phonetic: "/dɪsˈrʌpt/", meaning: "làm gián đoạn / phá vỡ", example: "New technologies will be disrupting traditional industries.", example2: "Startups are disrupting the banking sector.", collocation: "disrupt the market / disruptive technology", audio: "/audio/unit21/disrupt.mp3" },
  ],
  dialogues: [
    {
      id: 1,
