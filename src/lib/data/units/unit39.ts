...
// ─────────────────────────────────────────────────────────────────────────────
// UNIT-39 — Speculation & Deduction  (B2)
...
export const unit39: UnitData = {
  ...
  vocab: [
    { id: 1, word: "speculation", emoji: "💭", phonetic: "/ˌspekjʊˈleɪʃən/", meaning: "sự suy đoán / giả thuyết", example: "There is a lot of speculation about who will be the next CEO.", example2: "The report is based on facts, not speculation.", collocation: "pure speculation / fuel speculation / speculation about", audio: "/audio/unit39/speculation.mp3", l1_interference_vn: "⚠️ Đừng dịch 'word' theo nghĩa đen từng từ — học theo collocation trong ví dụ." },
    { id: 2, word: "deduction", emoji: "🧠", phonetic: "/dɪˈdʌkʃən/", meaning: "sự suy luận / kết luận rút ra", example: "His deduction turned out to be correct.", example2: "Through logical deduction, she identified the fault.", collocation: "logical deduction / deduction from / make a deduction", audio: "/audio/unit39/deduction.mp3", l1_interference_vn: "⚠️ Người Việt hay bỏ mạo từ 'the/a' trước 'deduction' trong câu trang trọng." },
    { id: 3, word: "proof", emoji: "📄", phonetic: "/pruːf/", meaning: "chứng cứ / bằng chứng xác thực", example: "Do you have any proof that he signed the contract?", example2: "The video is clear proof of the system failure.", collocation: "conclusive proof / proof of purchase / need proof", audio: "/audio/unit39/proof.mp3", l1_interference_vn: "⚠️ 'proof' thường đi với giới từ cố định — xem collocation, không dùng 'of/for' tùy tiện." },
    { id: 4, word: "trace", emoji: "🐾", phonetic: "/treɪs/", meaning: "dấu vết / manh mối nhỏ", example: "The hackers left no trace of their activity in the system.", example2: "We found traces of water in the server room.", collocation: "leave a trace / find a trace / trace elements", audio: "/audio/unit39/trace.mp3", l1_interference_vn: "⚠️ Phát âm cuối âm tiết của 'trace' rõ (/s/, /t/, /d/) — IELTS speaking." },
    { id: 5, word: "credible", emoji: "📰", phonetic: "/ˈkredəbəl/", meaning: "đáng tin cậy", example: "We need to find a credible source for this information.", example2: "Her explanation was not very credible.", collocation: "credible source / highly credible / credible evidence", audio: "/audio/unit39/credible.mp3", l1_interference_vn: "⚠️ 'credible' là danh từ không đếm được hoặc đếm được — không thêm 's' sai ngữ cảnh." },
    { id: 6, word: "deduce", emoji: "🧐", phonetic: "/dɪˈdjuːs/", meaning: "suy ra / kết luận dựa trên thực tế", example: "From the data, we can deduce that sales will rise next quarter.", example2: "What did you deduce from the survey results?", collocation: "deduce from / manage to deduce", audio: "/audio/unit39/deduce.mp3", l1_interference_vn: "⚠️ Trong email B2, 'deduce' đứng trong cụm trang trọng — tránh cấu trúc câu kiểu tiếng Việt." },
