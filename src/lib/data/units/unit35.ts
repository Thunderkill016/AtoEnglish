...
export const unit35: UnitData = {
  ...
  vocab: [
    { id: 1, word: "agreement", emoji: "🤝", phonetic: "/əˈɡriːmənt/", meaning: "sự thỏa thuận / hợp đồng", example: "Both parties finally signed the trade agreement.", example2: "We reached an agreement after a long negotiation.", collocation: "sign an agreement / reach an agreement / verbal agreement", audio: "/audio/unit35/agreement.mp3" },
    { id: 2, word: "negotiate", emoji: "🗣️", phonetic: "/nɪˈɡəʊʃɪeɪt/", meaning: "đàm phán / thương lượng", example: "We need to negotiate the price before making a order.", example2: "She is skilled at negotiating contracts.", collocation: "negotiate a contract / negotiate with / negotiate terms", audio: "/audio/unit35/negotiate.mp3" },
    ...
    { id: 12, word: "penalty", emoji: "💸", phonetic: "/ˈpenəlti/", meaning: "khoản phạt / hình phạt", example: "There will be a heavy penalty if we terminate the contract early.", example2: "The penalty for late submission is a lower grade.", collocation: "pay a penalty / penalty clause / death penalty", audio: "/audio/unit35/penalty.mp3" },
  ],
  dialogues: [
    {
      id: 1,
