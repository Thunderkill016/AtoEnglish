...
export const unit35: UnitData = {
  ...
  vocab: [
    ...
    { id: 3, word: "terms", emoji: "📋", phonetic: "/tɜːmz/", meaning: "các điều khoản (trong hợp đồng)", example: "The terms of the contract are very strict.", example2: "We are discussing the payment terms now.", collocation: "payment terms / terms of service / agree to terms", audio: "/audio/unit35/terms.mp3", l1_interference_vn: "⚠️ Đừng dịch 'terms' theo nghĩa đen từng từ — học theo collocation trong ví dụ." },
    { id: 4, word: "clause", emoji: "📌", phonetic: "/klɔːz/", meaning: "điều khoản nhỏ (trong văn bản pháp lý)", example: "There is a penalty clause for late delivery.", example2: "Please read the confidentiality clause carefully.", collocation: "penalty clause / confidentiality clause / add a clause", audio: "/audio/unit35/clause.mp3", l1_interference_vn: "⚠️ Người Việt hay bỏ mạo từ 'the/a' trước 'clause' trong câu trang trọng." },
    { id: 5, word: "condition", emoji: "⚙️", phonetic: "/kənˈdɪʃən/", meaning: "điều kiện", example: "We agreed to the contract under one main condition.", example2: "The working conditions in the factory are excellent.", collocation: "working condition / under the condition that / set conditions", audio: "/audio/unit35/condition.mp3", l1_interference_vn: "⚠️ 'condition' thường đi với giới từ cố định — xem collocation, không dùng 'of/for' tùy tiện." },
    { id: 6, word: "compliance", emoji: "🛡️", phonetic: "/kənˈplaɪəns/", meaning: "sự tuân thủ quy định/pháp luật", example: "The company is in compliance with safety standards.", example2: "We must ensure compliance with all environmental laws.", collocation: "in compliance with / ensure compliance / compliance officer", audio: "/audio/unit35/compliance.mp3", l1_interference_vn: "⚠️ 'In compliance WITH', không 'to' hay 'of'. Người VN hay dịch sai giới từ." },
    { id: 7, word: "contract", emoji: "📄", phonetic: "/ˈkɒntrækt/", meaning: "hợp đồng / giao kèo", example: "The contract will terminate at the end of the year.", example2: "She signed a two-year employment contract.", collocation: "sign a contract / terminate a contract / contract extension", audio: "/audio/unit35/contract.mp3", l1_interference_vn: "⚠️ 'Contract' có thể là danh từ hoặc động từ. 'Sign/terminate a contract' – collocation chuẩn." },
    { id: 8, word: "guarantee", emoji: "🛡️", phonetic: "/ˌɡærənˈtiː/", meaning: "sự bảo đảm / cam kết", example: "There is no guarantee that the investment will be successful.", example2: "The product comes with a three-year guarantee.", collocation: "offer a guarantee / money-back guarantee / guarantee that", audio: "/audio/unit35/guarantee.mp3", l1_interference_vn: "⚠️ 'Guarantee' + that clause. 'Money-back guarantee' phổ biến." },
    { id: 9, word: "terminate", emoji: "🛑", phonetic: "/ˈtɜːmɪneɪt/", meaning: "chấm dứt / hủy bỏ (hợp đồng)", example: "Either party can terminate the agreement with a one-month notice.", example2: "They decided to terminate his contract due to poor performance.", collocation: "terminate an agreement / terminate a contract / terminate employment", audio: "/audio/unit35/terminate.mp3", l1_interference_vn: "⚠️ 'Terminate' formal. 'End' casual hơn. 'Terminate with notice'." },
  ...
  jobScenarios: [
    { id: 1, title: "Professional presentation", focus: "B2 work skills", context: "office report", l1Note: "⚠️ 'In compliance with' chuẩn, không 'in compliance to'. Người VN hay nhầm giới từ.", example: "We are in full compliance with the new regulations." },
    { id: 2, title: "Contract negotiation", focus: "conditionals in business", context: "deal with foreign partner", l1Note: "⚠️ Mixed conditionals: past perfect in if-clause for unreal past affecting present.", example: "If we had included the penalty clause, we would be protected now." },
  ],
};
