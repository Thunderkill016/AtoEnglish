...
export const unit4: UnitData = {
  ...
  vocab: [
    ...
    { id: 6, word: "come home", emoji: "🏠", phonetic: "/kʌm həʊm/", meaning: "về nhà", example: "I come home at 6 pm.", example2: "She comes home tired after work.", collocation: "come home from work", audio: "/audio/unit4/come_home.mp3", l1_interference_vn: "⚠️ 'Come home' KHÔNG có 'to': 'come home', không phải 'come to home'. Tương tự: 'go home', 'arrive home'." },
    { id: 7, word: "cook dinner", emoji: "🍳", phonetic: "/kʊk ˈdɪnər/", meaning: "nấu bữa tối", example: "My mother cooks dinner every day.", example2: "I cook dinner for my family.", collocation: "cook dinner at home", audio: "/audio/unit4/cook_dinner.mp3", l1_interference_vn: "⚠️ 'Cook dinner' — KHÔNG 'cook the dinner' (không có 'the'). 'Make dinner' cũng đúng — hai collocation cùng nghĩa." },
    { id: 8, word: "watch TV", emoji: "📺", phonetic: "/wɒtʃ ˌtiːˈviː/", meaning: "xem tivi", example: "We watch TV in the evening.", example2: "He watches TV before going to bed.", collocation: "watch TV at night", audio: "/audio/unit4/watch_tv.mp3", l1_interference_vn: "⚠️ 'Watch TV' — KHÔNG 'see TV' hay 'look TV'. 'Watch' dùng cho chương trình/màn hình. 'See a movie' (ở rạp)." },
    ...
    { id: 10, word: "exercise", emoji: "🏃", phonetic: "/ˈeksəsaɪz/", meaning: "tập thể dục", example: "She exercises in the morning.", example2: "I exercise three times a week.", collocation: "exercise regularly", audio: "/audio/unit4/exercise.mp3", l1_interference_vn: "⚠️ 'Exercise' (n/v) không đếm được khi nói chung: 'I do exercise' hay 'I exercise'. KHÔNG 'I do an exercise' (cho gym)." },
