...
export const unit20: UnitData = {
  ...
  vocab: [
    { id: 1, word: "announce", emoji: "📢", phonetic: "/əˈnaʊns/", meaning: "thông báo / công bố", example: "The CEO announced the merger last Friday.", example2: "They had announced the results before we arrived.", collocation: "announce a decision / publicly announce", audio: "/audio/unit20/announce.mp3" },
    ...
    { id: 3, word: "decline", emoji: "📉", phonetic: "/dɪˈklaɪn/", meaning: "sụt giảm / từ chối", example: "Sales had declined by 20% before the new strategy was introduced.", example2: "He declined the offer after careful consideration.", collocation: "sharp decline / decline an offer / decline in sales", audio: "/audio/unit20/decline.mp3" },
    { id: 4, word: "investigate", emoji: "🔍", phonetic: "/ɪnˈvestɪɡeɪt/", meaning: "điều tra", example: "By the time police arrived, they had already investigated the scene.", example2: "The committee is investigating the fraud allegations.", collocation: "investigate a case / under investigation", audio: "/audio/unit20/investigate.mp3" },
    { id: 5, word: "resign", emoji: "🚪", phonetic: "/rɪˈzaɪn/", meaning: "từ chức", example: "The minister had resigned before the scandal became public.", example2: "She resigned from her position after 10 years.", collocation: "resign from a post / letter of resignation", audio: "/audio/unit20/resign.mp3" },
    { id: 6, word: "reveal", emoji: "💡", phonetic: "/rɪˈviːl/", meaning: "tiết lộ / cho thấy", example: "The investigation revealed that they had hidden the losses.", example2: "The report revealed serious problems in the process.", collocation: "reveal the truth / reveal details / reveal a secret", audio: "/audio/unit20/reveal.mp3" },
    { id: 7, word: "consequence", emoji: "⚡", phonetic: "/ˈkɒnsɪkwəns/", meaning: "hậu quả / kết quả", example: "The consequences of the decision had been severe.", example2: "As a consequence, the company lost several key clients.", collocation: "serious consequences / face the consequences / as a consequence", audio: "/audio/unit20/consequence.mp3" },
    { id: 8, word: "previously", emoji: "⏪", phonetic: "/ˈpriːviəsli/", meaning: "trước đây / trước đó", example: "He had previously worked at a rival company.", example2: "This policy had previously been rejected by the board.", collocation: "previously unknown / as mentioned previously", audio: "/audio/unit20/previously.mp3" },
    ...
    { id: 10, word: "confirm", emoji: "✅", phonetic: "/kənˈfɜːm/", meaning: "xác nhận", example: "The spokesperson confirmed that the CEO had resigned.", example2: "Please confirm your attendance by Friday.", collocation: "confirm a booking / officially confirm / confirm the news", audio: "/audio/unit20/confirm.mp3" },
    { id: 11, word: "acquire", emoji: "💰", phonetic: "/əˈkwaɪər/", meaning: "mua lại / thâu tóm", example: "By 2023, the company had acquired three smaller firms.", example2: "They are planning to acquire a competitor this year.", collocation: "acquire a company / acquisition deal", audio: "/audio/unit20/acquire.mp3" },
