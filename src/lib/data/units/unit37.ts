...
export const unit37: UnitData = {
  ...
  vocab: [
    ...
    { id: 7, word: "outline", emoji: "📌", phonetic: "/ˈaʊtlaɪn/", meaning: "phác thảo / vạch ra ý chính", example: "She outlined the project plan on the whiteboard.", example2: "The report outlines the main causes of the crisis.", collocation: "project outline / outline a plan / briefly outline", audio: "/audio/unit37/outline.mp3", l1_interference_vn: "⚠️ 'Outline the key points first' — người Việt hay viết lan man mà không 'outline' trước khi viết báo cáo." },
    { id: 8, word: "synthesize", emoji: "🧪", phonetic: "/ˈsɪnθəsaɪz/", meaning: "tổng hợp (thông tin, dữ liệu)", example: "The report synthesizes data from five different studies.", example2: "Students need to learn how to synthesize information.", collocation: "synthesize information / synthesize data / synthesize findings", audio: "/audio/unit37/synthesize.mp3", l1_interference_vn: "⚠️ 'Synthesize' = tổng hợp từ nhiều nguồn (khác 'summarize' chỉ tóm tắt một nguồn). Hay bị nhầm nghĩa." },
    ...
    { id: 10, word: "enhance", emoji: "✨", phonetic: "/ɪnˈhɑːns/", meaning: "nâng cao / cải thiện chất lượng", example: "The new features will enhance user experience.", example2: "We want to enhance our brand reputation.", collocation: "enhance performance / enhance quality / enhance customer satisfaction", audio: "/audio/unit37/enhance.mp3", l1_interference_vn: "⚠️ 'Enhance' nghĩa là cải thiện chất lượng (không chỉ tăng số). Người VN hay dùng 'increase' cho mọi thứ." },
    ...
    { id: 12, word: "substitute", emoji: "🔄", phonetic: "/ˈsʌbstɪtjuːt/", meaning: "thay thế / vật thay thế", example: "You can substitute honey for sugar in this recipe.", example2: "There is no substitute for hard work.", collocation: "substitute A for B / close substitute / act as a substitute", audio: "/audio/unit37/substitute.mp3", l1_interference_vn: "⚠️ 'Substitute A for B' = thay A vào vị trí B. Thứ tự giới từ hay bị đảo bởi người Việt." },
  ],
