...
export const unit36: UnitData = {
  ...
  vocab: [
    ...
    { id: 3, word: "examine", emoji: "🧐", phonetic: "/ɪɡˈzæmɪn/", meaning: "khảo sát / nghiên cứu / xem xét kỹ", example: "The researchers examined the samples under a microscope.", example2: "We need to examine the financial records in detail.", collocation: "examine the details / examine a patient / carefully examine", audio: "/audio/unit36/examine.mp3" },
    { id: 4, word: "isolate", emoji: "🧬", phonetic: "/ˈaɪsəleɪt/", meaning: "cô lập / tách biệt", example: "Scientists have managed to isolate the gene responsible for the disease.", example2: "The village was isolated by the heavy snowstorm.", collocation: "isolate a virus / isolate yourself / socially isolated", audio: "/audio/unit36/isolate.mp3" },
    { id: 5, word: "hypothesize", emoji: "💡", phonetic: "/haɪˈpɒθɪsaɪz/", meaning: "đưa ra giả thuyết", example: "It is hypothesized that early humans lived in this cave.", example2: "Scientists hypothesize that there is water on Mars.", collocation: "hypothesize that / widely hypothesized", audio: "/audio/unit36/hypothesize.mp3" },
    { id: 6, word: "obtain", emoji: "📥", phonetic: "/əbˈteɪn/", meaning: "thu được / đạt được / lấy được", example: "You must obtain permission before using the database.", example2: "Valuable data was obtained from the customer survey.", collocation: "obtain permission / obtain results / obtain information", audio: "/audio/unit36/obtain.mp3" },
    { id: 7, word: "publish", emoji: "📚", phonetic: "/ˈpʌblɪʃ/", meaning: "công bố / xuất bản", example: "The research findings were published in a medical journal.", example2: "She published her first novel last year.", collocation: "publish a report / publish an article / publish a book", audio: "/audio/unit36/publish.mp3" },
    { id: 8, word: "verify", emoji: "✔️", phonetic: "/ˈverɪfaɪ/", meaning: "xác minh / kiểm chứng", example: "Please verify your email address to complete registration.", example2: "We need to verify the source of the information.", collocation: "verify details / verify facts / verify identity", audio: "/audio/unit36/verify.mp3" },
    { id: 9, word: "demonstrate", emoji: "👩‍🏫", phonetic: "/ˈdemənstreɪt/", meaning: "chứng minh / giải thích / trình bày", example: "The study demonstrates the link between stress and health.", example2: "Let me demonstrate how the new software works.", collocation: "demonstrate that / clearly demonstrate / demonstrate a skill", audio: "/audio/unit36/demonstrate.mp3" },
    { id: 10, word: "identify", emoji: "🏷️", phonetic: "/aɪˈdentɪfaɪ/", meaning: "nhận diện / xác định", example: "The police are trying to identify the suspect.", example2: "We must identify the key factors causing the delay.", collocation: "identify a problem / identify a trend / identify opportunities", audio: "/audio/unit36/identify.mp3" },
