...
export const unit23: UnitData = {
  ...
  vocab: [
    ...
    { id: 5, word: "deadline", emoji: "⏰", phonetic: "/ˈdedlaɪn/", meaning: "hạn chót", example: "If we miss the deadline, we will face a penalty.", example2: "The project deadline is the end of the month.", collocation: "meet a deadline / miss a deadline / extend a deadline", audio: "/audio/unit23/deadline.mp3", l1_interference_vn: "⚠️ \'MEET a deadline\' (kịp hạn) hoặc \'MISS a deadline\' (trễ). Không phải \'do/finish the deadline\'." },
    { id: 6, word: "proposal", emoji: "📄", phonetic: "/prəˈpəʊzəl/", meaning: "đề xuất", example: "If you accept our proposal, we can start immediately.", example2: "She submitted a proposal for the new project.", collocation: "submit a proposal / accept a proposal / business proposal", audio: "/audio/unit23/proposal.mp3", l1_interference_vn: "⚠️ \'Proposal FOR\': \'a proposal for a new project\'. \'Make/submit a proposal\'." },
    { id: 7, word: "consequence", emoji: "⚡", phonetic: "/ˈkɒnsɪkwəns/", meaning: "hậu quả", example: "If you delay payment, the consequence is a 5% late fee.", example2: "Consider the consequences before making a decision.", collocation: "face the consequences / serious consequences", audio: "/audio/unit23/consequence.mp3", l1_interference_vn: "⚠️ \'Consequence OF\': \'consequences of climate change\'. Giới từ \'of\', không phải \'from\'." },
    { id: 8, word: "negotiate", emoji: "🤝", phonetic: "/nɪˈɡəʊʃieɪt/", meaning: "đàm phán", example: "If both sides negotiate fairly, they will reach an agreement.", example2: "We need to negotiate better terms with the supplier.", collocation: "negotiate a deal / negotiate terms / open to negotiation", audio: "/audio/unit23/negotiate.mp3", l1_interference_vn: "⚠️ \'Negotiate a deal/contract\' — không dùng \'negotiate to\' hay \'negotiate for sth\' trực tiếp." },
    { id: 9, word: "penalty", emoji: "💸", phonetic: "/ˈpenəlti/", meaning: "phạt / tiền phạt", example: "If you cancel after the deadline, you will pay a penalty.", example2: "The contract includes a penalty clause for late delivery.", collocation: "pay a penalty / impose a penalty / penalty clause", audio: "/audio/unit23/penalty.mp3", l1_interference_vn: "⚠️ \'Penalty FOR\': \'a penalty for breaking the law\'. Giới từ \'for\', không phải \'of\'." },
