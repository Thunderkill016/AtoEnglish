...
export const unit42: UnitData = {
  ...
  vocab: [
    ...
    { id: 6, word: "resolution", emoji: "✅", phonetic: "/ˌrezəˈluːʃən/", meaning: "sự giải quyết / nghị quyết", example: "Conflict resolution is a crucial management skill.", example2: "The dispute was brought to a successful resolution.", collocation: "conflict resolution / final resolution", audio: "/audio/unit42/resolution.mp3", l1_interference_vn: "⚠️ 'Resolution' trong business = giải quyết xung đột (không chỉ 'nghị quyết')." },
    { id: 7, word: "compliance", emoji: "🛡️", phonetic: "/kənˈplaɪəns/", meaning: "sự tuân thủ quy định/pháp luật", example: "The factory is in compliance with all safety standards.", example2: "We must ensure compliance with corporate policies.", collocation: "in compliance with / ensure compliance / compliance officer", audio: "/audio/unit42/compliance.mp3", l1_interference_vn: "⚠️ 'In compliance with' là cụm cố định. Người VN hay nói 'comply to' sai giới từ." },
    ...
    { id: 10, word: "nevertheless", emoji: "⚖️", phonetic: "/ˌnevəðəˈles/", meaning: "tuy nhiên / mặc dù vậy", example: "The risk was high; nevertheless, we signed the contract.", example2: "He was tired; nevertheless, he completed the report.", collocation: "nevertheless, S + V / but nevertheless", audio: "/audio/unit42/nevertheless.mp3", l1_interference_vn: "⚠️ 'Nevertheless' trang trọng hơn 'but'. Thường đứng đầu câu hoặc sau ; . Hay bị lạm dụng 'however'." },
    ...
    { id: 12, word: "validate", emoji: "✔️", phonetic: "/ˈvælɪdeɪt/", meaning: "xác thực / phê chuẩn", example: "We gathered data to validate our business model.", example2: "The manager validated the signature on the contract.", collocation: "validate data / validate a contract / validate findings", audio: "/audio/unit42/validate.mp3", l1_interference_vn: "⚠️ 'Validate findings' trong academic = chứng minh bằng dữ liệu. Hay dịch sai thành 'xác nhận' thông thường." },
  ],
