...
describe("Real Talk atomic private draft persistence", () => {
  it("derives the owner inside one security-invoker RPC", () => {
  ...
  it("writes video before lesson in the same transaction", () => {
  ...
  it("keeps repeat generation on one owner-private identity", () => {
  ...
  it("keeps application writes behind the atomic RPC", () => {
