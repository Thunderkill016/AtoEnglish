...
**Authored (playable):** `l-a0-01`, `l-a0-02`, `l-a0-03`, `l-a1-01`, `l-b1-01`  
**Progress:** localStorage `ato_v2_progress` until DB migration  
**Content factory priority:** finish P0 (`l-a0-04`…`l-a0-08`) then sequential A1 — no more empty maintenance-only autopilot.
