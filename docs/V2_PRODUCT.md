...
**Authored (playable):** `l-a0-01`…`l-a0-08` (P0 complete), `l-a1-01`, `l-b1-01`  
**Progress:** localStorage `ato_v2_progress` until DB migration  
**Content factory priority:** P0 done — sequential A1 (`l-a1-02`…) next; no empty maintenance-only autopilot.
