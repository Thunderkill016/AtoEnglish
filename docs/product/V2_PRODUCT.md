...
**Authored (playable):** `l-a0-01`…`l-a0-08` (P0 complete), `l-a1-01`…`l-a1-05`, `l-b1-01`  
...
**Content factory priority:** P0 done — sequential A1 (`l-a1-06`…) next; no empty maintenance-only autopilot.
