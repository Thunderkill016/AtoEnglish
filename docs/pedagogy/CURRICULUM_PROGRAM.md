...
> **Nền:** IPOR 10 · blueprint · unit1 · 50 unit đã ship · `docs/pedagogy/LESSON_SYSTEM_FOUNDATION.md` · `product-outcome.ts`.  
...
| Doc / code | Vai trò |
|-------------|---------|
| `docs/pedagogy/LESSON_SYSTEM_FOUNDATION.md` | Khoa học + blueprint + B1 north star |
