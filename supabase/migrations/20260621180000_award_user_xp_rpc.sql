-- =============================================================================
-- Atomic XP + streak updates (fixes read-then-write race on user_progress)
-- =============================================================================
...
COMMENT ON FUNCTION public.award_user_xp IS
  'Atomically increment total_xp and update streak/last_active_date for a user.';