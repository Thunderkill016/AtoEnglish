...
--
-- This migration stores the audit data required by an approved ingestion flow
-- and prevents ordinary authenticated clients from self-labelling transcript
-- evidence as reviewed. Experimental captions remain private-draft evidence.
