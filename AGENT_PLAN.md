...
|-------|-------|
| Started | 2026-07-10 |
| Focus | TASK-236 — Autopilot maintenance sweep #236 |
...
**Bước thực hiện**:
1. PHASE1 (done): AGENTS.md, BACKLOG (TASK-236 ready; 237–238 ready), PLAN prior TASK-235 done e4b6b51, CONTENT_STYLE §6–7 (context only — no unit edit).
2. BACKLOG TASK-236 → `in_progress`.
3. Ready after in_p: 2 (237–238) ≥ 2 → skip refill.
4. PHASE3:
...
5. Log `logs/agent/*_TASK-236.log`; BACKLOG done + Nhật ký + SHA; PLAN completed; commit + `bash scripts/git-push.sh main`.
