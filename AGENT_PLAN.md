...
|-------|-------|
| Started | 2026-07-10 |
| Focus | TASK-237 — Autopilot maintenance sweep #237 |
...
**Bước thực hiện**:
1. PHASE1 (done): AGENTS.md, BACKLOG (TASK-237 ready; 238 ready), PLAN prior TASK-236 done 2ddd548, CONTENT_STYLE §6–7 (context only — no unit edit).
2. BACKLOG TASK-237 → `in_progress`.
3. Ready after in_p: 1 (238) < 2 → run `bash scripts/agent-refill-backlog.sh`.
4. PHASE3:
...
5. Log `logs/agent/*_TASK-237.log`; BACKLOG done + Nhật ký + SHA; PLAN completed; commit + `bash scripts/git-push.sh main`.
