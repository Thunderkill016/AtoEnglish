...
- Name: protected-routes.spec.ts >> Protected Routes — Unauthenticated Redirects >> /leaderboard redirects to /login when not logged in
...
Received string:  "http://localhost:3000/leaderboard"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    13 × unexpected value "http://localhost:3000/leaderboard"
...
- main:
  - text: Bảng xếp hạng
  - heading "Top Học Viên" [level=1]
  - paragraph: Cạnh tranh lành mạnh để duy trì động lực học tiếng Anh mỗi ngày.
  - button "Tuần này"
  - button "Tất cả thời gian"
  - button "Giải đấu của tôi"
  - text: Bạn cần đăng nhập.
  - paragraph: Reset vào thứ Hai mỗi tuần 🔄
