...
- Name: protected-routes.spec.ts >> Protected Routes — Unauthenticated Redirects >> /writing redirects to /login when not logged in
...
Received string:  "http://localhost:3000/writing"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    13 × unexpected value "http://localhost:3000/writing"
...
- main:
  ...
  - link "Câu đã lưu":
    - /url: /writing/history
  - heading "Viết & Cải thiện" [level=1]
  - paragraph: Nhập câu tiếng Anh — AI sẽ sửa lỗi, giải thích bằng tiếng Việt, và gợi ý cách viết hay hơn.
  - button "A1 — Cơ bản Câu đơn giản"
  - button "A2 — Sơ cấp Câu phức đơn giản"
  - button "B1 — Trung cấp Câu phức, từ vựng rộng hơn"
  - paragraph: Câu mẫu để luyện tập
  - button "“My name is Lan. I am student. I like reading book.”"
  - button "“She go to school every day. She have many friends.”"
  - button "“I am from Vietnam. I lives in Hanoi.”"
  - textbox "Nhập câu hoặc đoạn văn tiếng Anh của bạn tại đây..."
  - text: 0/500 ký tự
  - button "Phân tích" [disabled]
