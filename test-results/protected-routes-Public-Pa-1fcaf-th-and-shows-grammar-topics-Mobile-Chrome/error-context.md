...
- Name: protected-routes.spec.ts >> Public Pages — Accessible Without Auth >> /grammar loads without auth and shows grammar topics
- Location: e2e/protected-routes.spec.ts:52:7
...
Call log:
  ...
  - waiting for locator('h2, h3').first()
