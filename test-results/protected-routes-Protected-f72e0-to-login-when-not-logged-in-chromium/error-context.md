...
- Name: protected-routes.spec.ts >> Protected Routes — Unauthenticated Redirects >> /placement-test redirects to /login when not logged in
...
Received string:  "http://localhost:3000/placement-test"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    12 × unexpected value "http://localhost:3000/placement-test"
...
- main:
  - main:
    ...
    - heading "Xác Định Trình Độ Tiếng Anh" [level=1]
    - paragraph:
      - text: Bài test chuẩn CEFR gồm
      - strong: 40 câu hỏi
      - text: — Grammar, Vocabulary và Reading. Mất khoảng
      - strong: 15–25 phút
      - text: . Không giới hạn thời gian.
    - text: 📖 19 Reading 📝 12 Vocabulary 💬 9 Language Use Kết quả xác định A1 A2 B1 B2 Lưu ý Câu hỏi bằng tiếng Anh — đọc kỹ trước khi chọn Không thể quay lại câu trước Kết quả tự động cập nhật level trong app Làm thật — đừng đoán mò để kết quả chính xác nhất
    - button "Bắt Đầu Test"
